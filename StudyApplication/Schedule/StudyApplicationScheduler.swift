...
extension StudyApplicationScheduler {
    static var socialSupportTask: SpeziScheduler.Task<StudyApplicationTaskContext> {
        ...
        return Task(
            ...
            notifications: true,
            context: StudyApplicationTaskContext.questionnaire(Bundle.main.questionnaire(withName: "SocialSupportQuestionnaire"))
        )
    }

    /// Creates a default instance of the ``StudyApplicationScheduler`` by scheduling the tasks listed below.
    convenience init() {
